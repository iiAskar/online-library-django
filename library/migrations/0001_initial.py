    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('book_id_json', models.CharField(help_text='Corresponds to bookId in original JSON', max_length=20, unique=True)),
                ...
                ('cover_image_path', models.CharField(blank=True, help_text="Path to image, e.g., 'images/book1.jpg'", max_length=255, null=True)),
